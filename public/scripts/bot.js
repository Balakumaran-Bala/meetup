...
socket3.emit('updateLocation', {'x': 29.5161656, 'y': -95.28864920000001}); // destination {'x': 29.7853358, 'y': -95.49261059999998}
var destination = {'x': 29.7853358, 'y': -95.49261059999998};
var tLoc = [29.5161656, -95.28864920000001];
var xChange = (29.7853358-29.5161656)/60.0;
var yChange = (-95.49261059999998+95.28864920000001)/60.0;
...
socket4.emit('updateLocation', {'x': 29.6393083, 'y': -95.26521969999999});
